...
class Producer():
    def __init__(self):
        ...
        self.user = conf['prmq']['user'].value
        self.password = conf['prmq']['password'].value
        self.ip = conf['prmq']['ip'].value
        self.port = int(conf['prmq']['port'].value)
        self.vhost = conf['prmq']['vhost'].value
        # self.queue = conf['prmq']['queue'].value
        # self.queue = queue
